...
class aplication:
    ...
    def __init__(self, master=None):
        ...
        self.lbidusuario = Label(self.container2, text="idsuario: ", font= self.fonte, width=10)
        ...
        self.textnome = Entry(self.container3)
        self.textnome["width"] = 25
        self.textnome["font"] = self.fonte
        ...
        self.lblsenha = Label(self.container7, text="Senha",fonte=self.fonte ,width=10)
    ...
    def buscarUsuario(self):    
        ...
        self.lblmsg["text"] = user.selectUsuario(idusuario)
